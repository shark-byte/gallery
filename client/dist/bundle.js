...
var _reactPhotoGallery = __webpack_require__(43);

var _reactPhotoGallery2 = _interopRequireDefault(_reactPhotoGallery);

var _SlideShowView = __webpack_require__(48);

var _SlideShowView2 = _interopRequireDefault(_SlideShowView);

var _TopNav = __webpack_require__(97);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.galleryImageCountClick = _this.galleryImageCountClick.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      var pics = this.props.data.photos;
      var urls = [];
    ...
    key: 'onGridButtonClick',
    value: function onGridButtonClick() {
      this.closeLightbox();
    ...
    key: 'assignRandomCaption',
    value: function assignRandomCaption() {
      var reviews = this.props.data.reviews;
      var randomReview = reviews[Math.floor(Math.random() * reviews.length)];
      var name = randomReview.name.toUpperCase();
      var randomCaption = _react2.default.createElement(
        'div',
        { className: 'author-details' },
        _react2.default.createElement('img', { src: randomReview.avatar, alt: '', className: 'avatar' }),
    ...
    key: 'galleryImageCountClick',
    value: function galleryImageCountClick() {
      this.setState({
        currentImage: 0,
        lightboxIsOpen: true
      });
    ...
    value: function render() {
      var photoCount = this.state.photos.length;
      return _react2.default.createElement(
        'div',
        { id: 'main-app' },
        _react2.default.createElement(
        ...
        _react2.default.createElement(_SlideShowView2.default, {
...
if (typeof window !== 'undefined') {
  _reactDom2.default.render(_react2.default.createElement(App, { data: window.galleryData }), document.getElementById('gallery'));
}
exports.App = App;
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(17),B=__webpack_require__(7),C=__webpack_require__(3),ba=__webpack_require__(18),da=__webpack_require__(19),ea=__webpack_require__(20),fa=__webpack_require__(21),ia=__webpack_require__(22),D=__webpack_require__(9);
...
var _Photo = __webpack_require__(46);
...
function SlideShowView(props) {
  var gridViewButton = // for future modal grid gallery view
  _react2.default.createElement(
    'button',
    {
      className: 'grid-view-button',
      onClick: function onClick() {
        return props.gridButtonClick();
      }
    },
    _react2.default.createElement('i', { className: 'fa fa-th fa-2x' })
  );

  var name = props.placeName.toUpperCase();
  var placeName = _react2.default.createElement(
    'div',
    { className: 'place-name' },
    name
  );
  var photoCounter = _react2.default.createElement(
    'div',
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactImages2.default, {
      ...
      onClose: function onClose() {
        return props.closeLightbox();
      },
      onClickPrev: function onClickPrev() {
        return props.clickPrev();
      },
      onClickNext: function onClickNext() {
        return props.clickNext();
      },
...
SlideShowView.propTypes = {
  photos: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    ...
    width: _propTypes2.default.number.isRequired,
    height: _propTypes2.default.number.isRequired,
    caption: _propTypes2.default.object.isRequired
  })).isRequired,
  current: _propTypes2.default.number.isRequired,
  placeName: _propTypes2.default.string.isRequired,
  isLightboxOpen: _propTypes2.default.bool.isRequired,
  closeLightbox: _propTypes2.default.func.isRequired,
  clickPrev: _propTypes2.default.func.isRequired,
  clickNext: _propTypes2.default.func.isRequired,
  gridButtonClick: _propTypes2.default.func.isRequired
};
...
var _Spinner = __webpack_require__(94);
...
function TopNav() {
  return _react2.default.createElement(
    'div',
    { id: 'top-nav', style: { height: 60, background: 'white' } },
    _react2.default.createElement(
      'div',
      { id: 'logo' },
      _react2.default.createElement('img', { src: 'http://res.cloudinary.com/madlicorice/image/upload/v1520454562/small_logo.png', alt: '', className: 'logo' })
    ),
    _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement(
        'form',
        null,
        _react2.default.createElement('input', { type: 'text', placeholder: 'Find a great place near you', name: 'search' }),
        _react2.default.createElement(
          'button',
          { type: 'submit' },
